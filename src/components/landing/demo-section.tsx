    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-4 lg:grid-cols-2 lg:gap-16">
        <div className={cn(reversed && "lg:order-2")}>
          <span className="inline-flex items-center rounded-full border border-accent/30 bg-accent/10 px-3.5 py-1.5 text-xs font-extrabold uppercase tracking-wider text-accent">
            {eyebrow}
          </span>
